...
namespace JapaneseLearningApp
{
    public partial class LecturesList : UserControl
    {
        ...
        {            
            this.mainPanel.Controls.Add(new StoryPanel(this.mainPanel, 0, this.currentUser));
            this.mainPanel.Controls.Remove(this);
        }

        private void bLecture1_Click(object sender, EventArgs e)
        {
            this.mainPanel.Controls.Add(new StoryPanel(this.mainPanel, 1, this.currentUser));
            this.mainPanel.Controls.Remove(this);
        }

        private void bLecture2_Click(object sender, EventArgs e)
        {
            this.mainPanel.Controls.Add(new StoryPanel(this.mainPanel, 2, this.currentUser));
            this.mainPanel.Controls.Remove(this);
        }

        private void bLecture3_Click(object sender, EventArgs e)
        {
            this.mainPanel.Controls.Add(new StoryPanel(this.mainPanel, 3, this.currentUser));
            this.mainPanel.Controls.Remove(this);
        }

        private void bLecture4_Click(object sender, EventArgs e)
        {
            this.mainPanel.Controls.Add(new StoryPanel(this.mainPanel, 4, this.currentUser));
            this.mainPanel.Controls.Remove(this);
        }

        private void bLecture5_Click(object sender, EventArgs e)
        {
            this.mainPanel.Controls.Add(new StoryPanel(this.mainPanel, 5, this.currentUser));
            this.mainPanel.Controls.Remove(this);
        }

        private void bLecture6_Click(object sender, EventArgs e)
        {
            this.mainPanel.Controls.Add(new StoryPanel(this.mainPanel, 6, this.currentUser));
            this.mainPanel.Controls.Remove(this);
        }

        private void bLecture7_Click(object sender, EventArgs e)
        {
            this.mainPanel.Controls.Add(new StoryPanel(this.mainPanel, 7, this.currentUser));
            this.mainPanel.Controls.Remove(this);
        }

        private void bLecture8_Click(object sender, EventArgs e)
        {
            this.mainPanel.Controls.Add(new StoryPanel(this.mainPanel, 8, this.currentUser));
            this.mainPanel.Controls.Remove(this);
        }

        private void bLecture9_Click(object sender, EventArgs e)
        {
            this.mainPanel.Controls.Add(new StoryPanel(this.mainPanel, 9, this.currentUser));
            this.mainPanel.Controls.Remove(this);
        }

        private void bLecture10_Click(object sender, EventArgs e)
        {
            this.mainPanel.Controls.Add(new StoryPanel(this.mainPanel, 10, this.currentUser));
            this.mainPanel.Controls.Remove(this);
        }

        private void bLecture11_Click(object sender, EventArgs e)
        {
            this.mainPanel.Controls.Add(new StoryPanel(this.mainPanel, 11, this.currentUser));
            this.mainPanel.Controls.Remove(this);
        }

        private void bLecture12_Click(object sender, EventArgs e)
        {
            this.mainPanel.Controls.Add(new StoryPanel(this.mainPanel, 12, this.currentUser));
            this.mainPanel.Controls.Remove(this);
        }
